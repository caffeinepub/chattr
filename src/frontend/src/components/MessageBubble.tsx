...
export default function MessageBubble({ 
  ...
  // Cast message to access imageId and giphyUrl fields
  const messageWithMedia = message as any;
  const imageId = messageWithMedia.imageId as bigint | undefined;
  const giphyUrl = messageWithMedia.giphyUrl as string | undefined;

  // Fetch image if imageId is present
  const { data: imageBlob } = useGetImage(imageId !== undefined ? imageId : null);
  ...
  const hasImage = imageId !== undefined && imageId !== null;
  const hasGif = giphyUrl !== undefined && giphyUrl !== null;
